...
Learning goal: Understand HyperCubes and how they can be used to create charts. The code for this chapter can be found [here](https://github.com/axisgroup/qix-tutorial-seed/tree/108-hypercubes).
...
<div id="line-chart" class="graph">![](../../imgs/line-chart-no-null.png)</div>
...
<div id="table-layout" class="graph">![](../../imgs/table-layout-2.png)</div>
...
<div id="dm" class="graph">![](../../imgs/data-model.png)</div>
...
Let’s set up a Generic Object definition for this chart. Create a new file called _chart-cube.json_ in the _src/defs_ folder:
</br>
</br>
...
<div id="line-chart-initial" class="graph">![](../../imgs/line-chart-initial.png)</div>
...
<div id="line-chart-final" class="graph">![](../../imgs/line-chart-finished.png)</div>
