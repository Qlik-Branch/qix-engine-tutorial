...
<div id="embed-dashboard" class="graph">![](../../imgs/monitor-qs-empty.png)</div>
...
<div id="state-machine" class="graph"></div>
...
Take our current state for example, where we’ve selected "T-Shirt" and "Camera" in the Item field.
...
#### Resources
* [Qlik Associative Model Whitepaper](http://global.qlik.com/uk/~/media/Files/resource-library/global-us/register/whitepapers/WP-Qlik-Associative-Model-EN)
* [The associative selection model ‒ Qlik Sense](http://help.qlik.com/en-US/sense/3.1/Subsystems/Hub/Content/Selections/associative-selection-model.htm)
* [Qlik Shades of Gray](https://www.youtube.com/watch?v=6Ab12POe62Q)